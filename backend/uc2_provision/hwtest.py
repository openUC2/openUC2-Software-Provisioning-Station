...
TEST_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "channels": [1, 2, 3],
        # Laser value is a 10-bit DAC (0-1023) — see uc2rest.laser.set_laser.
        "slider": {"min": 0, "max": 1023, "default": 1023, "label": "Laser value"},
        "actions": [
            {"id": "on", "name": "On", "per_channel": True, "uses_value": True,
             "confirm": "Is this channel emitting?"},
            {"id": "off", "name": "Off", "per_channel": True},
            {"id": "blink", "name": "Blink", "per_channel": True, "uses_value": True,
    ...
    },
    {
        ...
        "slider": {"min": 0, "max": 1023, "default": 1023, "label": "LED intensity"},
        "actions": [
            {"id": "all_on", "name": "All on", "uses_value": True,
             "confirm": "Are all LEDs lit evenly?"},
            {"id": "single", "name": "Single LED", "uses_value": True,
             "confirm": "Is exactly one LED lit?"},
            {"id": "left", "name": "Left half", "uses_value": True},
            {"id": "right", "name": "Right half", "uses_value": True},
            {"id": "off", "name": "Off"},
        ],
    },
    {
